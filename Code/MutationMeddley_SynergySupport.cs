    ...
    public static class MutationMeddley_TagRegistry
    {
        private static readonly Dictionary<string, string[]> MutationMeddley_VanillaTags =
            new Dictionary<string, string[]>(StringComparer.Ordinal)
            {
                ...
                { "Electrical Generation", new string[] { "ELECTRICAL", "ENERGY", "METABOLIC" } },
                { "Light Manipulation", new string[] { "RADIANT", "LIGHT_INTERACTION", "ENERGY" } },
                { "Flaming Ray", new string[] { "THERMAL", "RADIANT", "ENERGY" } },
                { "Freezing Ray", new string[] { "THERMAL", "ENVIRONMENTAL", "ENERGY" } },
                { "Photosynthetic Skin", new string[] { "BIOLOGICAL", "RADIANT", "METABOLIC" } },
                { "Phasing", new string[] { "PHASE", "REALITY", "MOBILE" } },
